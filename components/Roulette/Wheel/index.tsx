...
export const Wheel = ({
	...
	return (
		<RouletteContainer className='h-[80vw] w-[80vw] md:h-[70vw] md:w-[70vw] lg:h-[60vw] lg:w-[60vw] xl:h-[38vw] xl:w-[38vw]'>
			<RotationContainer
			...
			<img
				src={selectorImage}
				className='absolute w-80 object-contain [transform:rotate(-40deg)] z-5 -right-50 -top-28 xl:-right-40 xl:-top-28 pt-28'
				alt='roulette-static'
			/>
		</RouletteContainer>
	);
